...
{
    /// <inheritdoc />
    public partial class AddTallerYFechasManuales : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("DROP INDEX IF EXISTS \"IX_AusenciasProgramadas_InscripcionId\"");
